...
public class Blinky extends Fantom
{
    public Blinky(Labyrinthe labPar, Pacman pacParCible)
    {
        super(labPar, pacParCible);
        
        try {
            this.imgNotFrightened   = new Image(Constantes.sCHEMIN_TEXTURE_BLINKY);
    ...
    {
        float fPosCibleColonne  = Constantes.iCOLONNE_COIN_HAUT_DROIT * Constantes.iTAILLE_TILE_WIDTH;
        float fPosCibleLigne    = Constantes.iLIGNE_COIN_HAUT_DROIT * Constantes.iTAILLE_TILE_HEIGHT;
